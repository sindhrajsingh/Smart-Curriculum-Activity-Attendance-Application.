...
const AttendanceList = () => {
  ...
  const getStatusColor = (status) => {
    switch(status) {
      ...
      case 'Late': return { bg: '#F59E0B', light: '#FEF3C7', text: '#92400E' };
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              {submitting ? '⏳ Adding...' : '➕ Add Attendance Record'}
            </button>
          </form>
        </div>
        ...
        <div style={{
          ...
          {records.length === 0 ? (
            <div style={{
              ...
              <p style={{ fontSize: '18px', margin: 0 }}>No attendance records yet</p>
            ...
            <div style={{
              ...
              {records.map(rec => {
                const statusColors = getStatusColor(rec.status);
                return (
                  <div
                    key={rec._id}
                    style={{
